...
L["LFG_BUTTONS_TT"] = "在目标追踪器中添加组队查找器按钮。启用此设置可能会增加内存和 CPU 的使用率。|cFFFF5555A 此设置需要重载用户界面才能生效。|r"
...
L["COMBATLOCK"] = "戰鬥中無法使https://wow.curseforge.com/projects/localization/translations/1357508/approve用"
L["DEFAULT_TAB"] = "預設標籤"
