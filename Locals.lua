...
L["MAP_FILTER_DISABLED_INFO"]	= "You have some filters disabled under the magnifying glass ar the top right of the world map. This may hide some quests from the list, and disabled some filter options.";
