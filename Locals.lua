...
L["GENERIC_ANIMA_TT"] = "Replace the different anima item textures with matching ones, much like Azerite had. The only affects map icons and the quest list."
...
L["TRACKDD_TOMTOM"] = "Zu TomTom hinzufügen"
L["TRACKDD_TOMTOM_REMOVE"] = "Von TomTom entfernen"
